...
static void usage(void) {
    ...
    write_str_c(STDOUT_FILENO, "  pattern itself carries a capital.\033[0m\n\n", c);
    ...
    write_str_c(STDOUT_FILENO, "  \033[33m-i\033[0m, \033[33m--ignore-case\033[0m       fold case in names and content\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m--case-sensitive\033[0m        match as typed\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m-E\033[0m, \033[33m--exclude\033[0m <glob>    skip names matching glob\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m-c\033[0m, \033[33m--content\033[0m <text>    search file contents\n", c);
    ...
    write_str_c(STDOUT_FILENO, "  \033[33m-H\033[0m, \033[33m--hidden\033[0m            include dot files and dirs\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m-u\033[0m, \033[33m--unrestricted\033[0m      --hidden --no-ignore\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m-L\033[0m, \033[33m--follow\033[0m            follow symlinked directories\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m--depth\033[0m <N>             max recursion depth\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m--max-results\033[0m <N>       stop after N matches\n", c);
    ...
    write_str_c(STDOUT_FILENO, "  \033[33m--no-ignore\033[0m             do not read .gitignore\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m--no-messages\033[0m           do not report unreadable paths\n", c);
    write_str_c(STDOUT_FILENO, "  \033[33m--no-config\033[0m             skip ~/.cromrc\n", c);
